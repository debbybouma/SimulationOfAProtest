...
to go
  ...
  ; advance clock and update plots
    repeat 5 [ ask cops [ fd 0.2 ] display ]
...
to enforce
  ifelse (any? (agents-on neighborhood) with [ active? ] ) [
    ; arrest suspect
...
to find-flockmates
  set flockmates other cops in-radius vision
end
...
@#$#@#$#@
<experiments>
  <experiment name="flocks 1 5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
  ...
  <experiment name="flocks 1 7.5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="flocks 1 10" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="flocks 1 12.5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="flocks 1 15" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="flocks 5 15" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="flocks 5 12.5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="flocks 5 10" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="flocks 5 7.5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="flocks 5 5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="Flocks" repetitions="16" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
