...
@#$#@#$#@
<experiments>
  <experiment name="communicatie radius 2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
  ...
  <experiment name="communicatie radius 4" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="communicatie radius 6" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="communicatie radius 8" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="communicatie radius 10" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="communicatie radius 12" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="communicatie radius 14" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="communicatie radius 16" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="communicatie radius 18" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="communicatie radius 20" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="Radius" repetitions="16" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
