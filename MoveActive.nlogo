...
@#$#@#$#@
<experiments>
  <experiment name="intimidation 2 45" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
  ...
  <experiment name="intimidation 2 40" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="intimidation 2 50" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="intimidation 2 55" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="intimidation 4 40" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="intimidation 4 45" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="intimidation 4 50" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="intimidation 4 55" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="intimidation 4 60" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="intimidation 2 60" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="ActiveMove" repetitions="16" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
