...
@#$#@#$#@
<experiments>
  <experiment name="tijdens 10" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
  ...
  <experiment name="tijdens 4" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="tijdens 2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="tijdens 6" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="tijdens 8" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="tijdens 12" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="tijdens 14" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="tijdens 16" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="tijdens 18" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="tijdens 20" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>count agents with [ active? ]</metric>
  ...
  <experiment name="Blockages - During" repetitions="16" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="250"/>
